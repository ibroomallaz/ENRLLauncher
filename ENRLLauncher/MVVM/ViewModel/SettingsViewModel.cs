...
public class SettingsViewModel : ObservableObject
{
    ...
    public bool StartInFullScreen
    {
        ...
        set
        {
            if (!Set(ref _startInFullScreen, value)) return;
    ...
    public bool LaunchOnWindowsStartup
    {
        ...
        set
        {
            if (!Set(ref _launchOnWindowsStartup, value)) return;
            HasUnsavedChanges = true;
            StatusMessage = "Unsaved changes";
        }
    }
    ...
    public string AppVersionDisplay { get; } = FormatAppVersion(Globals.g_AppVersion);
    public string FileVersionDisplay => Globals.g_FileVersion;
    public string DeveloperName => "Isaac Broomall";
    public string DeveloperCredit => $"Developed by {DeveloperName}";
    public string GithubUrl => Globals.g_GithubUrl;
        ...
        IAppLogger? logger = null)
    {
        ...
        ImportLayoutCommand = new RelayCommand(unused => _ = ExecuteImportLayoutAsync());
        ...
        CheckForUpdatesCommand = new RelayCommand(unused => _ = ExecuteCheckForUpdatesAsync(), _ => !IsCheckingForUpdates);
    ...
    {
        var owner = Application.Current?.MainWindow;
        if (_versionCheckerUi is { IsUpdateAvailable: true })
        {
    ...
    private async Task ExecuteImportLayoutAsync()
    {
